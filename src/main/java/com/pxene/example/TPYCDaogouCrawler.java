 ...
 */
public class TPYCDaogouCrawler {
    ...
    public static void main(String[] args) throws IOException {
        PageExtract indexPage = PageExtract.builder().httpSender()
                ...
                .configMultiValueColumn("url", "#nav > li:nth-child(3) > a, #nav > li:nth-child(4) > a, #nav > li:nth-child(5) > a, #nav > li:nth-child(6) > a", "href").end()
                .build();
        ...
        String rootUrl = "http://www.pcauto.com.cn/teach/";
