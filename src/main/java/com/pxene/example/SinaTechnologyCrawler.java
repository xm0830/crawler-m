 ...
 */
public class SinaTechnologyCrawler {
    public static void main(String[] args) throws IOException {
        PageExtract menuPage = PageExtract.builder().httpSender()
                ...
                .configMultiValueColumn("url", "#techniqueLink > li > a", "href").end()
                .build();
        ...
        PageExtract listPage = PageExtract.builder().httpSender()
                ...
                .addHeader("Upgrade-Insecure-Requests", "1").end().htmlFetcher()
                .configMultiValueColumn("url", "div.wrap > div.w_l > ul > li > p > a, div.wrap > div > div.noun-body > dl > dd > a", "href")
        ...
        PageExtract resultPage = PageExtract.builder().httpSender()
                ...
                .addHeader("Upgrade-Insecure-Requests", "1").end().htmlFetcher()
                .configSingleValueColumn("title", "#artibodyTitle", null)
                .configSingleValueColumn("content", "#articleContent", null)
        ...
        String rootUrl = "http://auto.sina.com.cn/jishu/index.d.html";
        ...
        for (String url : urls) {
            ...
            for (int i = 1; ; i++) {
                ...
                if (i == 1) {
                    ...
                    if (url.endsWith("jishujiedu") || url.endsWith("gongchangtanmi")) {
                        tmpUrl = url + i + "/";
                        tmpRefer = url + (i-1) + "/";
                    } else {
                        tmpUrl = url + i + ".shtml";
