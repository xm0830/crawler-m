...
public class SinaNewsCrawler {
    public static void main(String[] args) throws IOException {
        ...
        PageExtract listPage = PageExtract.builder().httpSender()
                ...
                .addHeader("Upgrade-Insecure-Requests", "1").end().htmlFetcher()
                .configMultiValueColumn("url", "div.content > div.con > div.single > div.s-left > h3 > a, div.content > div.salon > ul > li > p.tit > a", "href").end()
                .build();
        ...
        String rootUrl = "http://auto.sina.com.cn/news/index.d.html";
