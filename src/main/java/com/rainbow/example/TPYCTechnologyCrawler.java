 ...
 */
public class TPYCTechnologyCrawler {
    ...
    public static void main(String[] args) throws IOException {
        PageExtract indexPage = PageExtract.builder().httpSender()
                ...
                .configMultiValueColumn("url", "div.wrapper div.chaMenu > ul > li:nth-child(2) > a, div.wrapper div.chaMenu > ul > li:nth-child(3) > a, div.wrapper div.chaMenu > ul > li:nth-child(4) > a, div.wrapper div.chaMenu > ul > li:nth-child(5) > a", "href").end()
                .build();
        ...
        String rootUrl = "http://arch.pcauto.com.cn/tech/";
