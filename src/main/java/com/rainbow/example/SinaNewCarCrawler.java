 ...
 */
public class SinaNewCarCrawler {
    public static void main(String[] args) throws IOException {
        PageExtract menuPage = PageExtract.builder().httpSender()
                ...
                .addHeader("If-Modified-Since", "Thu, 04 May 2017 06:06:00 GMT")
                .addHeader("Upgrade-Insecure-Requests", "1").end().htmlFetcher()
                .configMultiValueColumn("url", "#newCarLink > li > a", "href").end()
                .build();
        ...
        PageExtract listPage = PageExtract.builder().httpSender()
                ...
                .addHeader("If-Modified-Since", "Thu, 04 May 2017 06:11:00 GMT")
                .addHeader("Upgrade-Insecure-Requests", "1").end().htmlFetcher()
        ...
        String rootUrl = "http://auto.sina.com.cn/newcar/index.d.html";
