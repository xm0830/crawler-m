 ...
 */
public class TPYCHangqingCrawler {
    ...
    public static void main(String[] args) throws IOException {
        PageExtract indexPage = PageExtract.builder().httpSender()
                ...
                .configMultiValueColumn("url", "div.wrapper div.chaMenu > ul > li:nth-child(2) > a, div.wrapper div.chaMenu > ul > li:nth-child(3) > a", "href").end()
                .build();
        ...
        String rootUrl = "http://www.pcauto.com.cn/qcbj/";
